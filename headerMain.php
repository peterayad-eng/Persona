                ...
                <div class="container-fluid">
                    ...
                    <div id="navbarToggler" class="collapse navbar-collapse">
                        <ul id="navList" class="navbar-nav ms-auto mb-2 mb-lg-0 navul">
                            <li id='home-nav' class="nav-item ntab ps-2 pe-2"><a id='homeNav' class="nav-link navlink active selected white" aria-current="page" href="#carousel">Home</a></li>
                            <li id='service-nav' class="nav-item ntab ps-2 pe-2"><a id='servicesNav' class="nav-link navlink white" href="#services">Service</a></li>
                            <li id='aboutus-nav' class="nav-item ntab ps-2 pe-2"><a id='aboutNav' class="nav-link navlink white" href="#aboutus">About us</a></li>
                            <li id='contacts-nav' class="nav-item ntab ps-2 pe-2"><a id='contactsNav' class="nav-link navlink white" href="#application">Contacts</a></li>
