...
<html lang="en">	
	<head>
        ...
        <meta http-equiv="Content-Security-Policy" content="default-src 'self'; style-src 'self' 'unsafe-inline'; img-src *; media-src 'none' ; child-src https://www.google.com; script-src 'self' 'sha256-B8XxDv8cQgLWNTwbmrYhZyjFAdEvAGjJb9rfh+ljfd4=' 'sha256-A9FjnGtxGjGcayHBdO9oPi18v9GCIfg2RMocLGdDgDg='">
        ...
        <link href="fontawesome6.0.0/css/solid.css" rel="stylesheet">
        <link href="fontawesome6.0.0/css/regular.css" rel="stylesheet">
            ...
            <nav class="navbar navbar-expand-md fixed-top">
                <div class="container-fluid">
                    ...
                    <div id="navbarToggler" class="collapse navbar-collapse">
                        <ul id="navList" class="navbar-nav ms-auto mb-2 mb-lg-0 navul">
                            <li id='home-nav' class="nav-item ntab ps-2 pe-2"><a id='homeNav' class="nav-link navlink active selected white" aria-current="page" href="index">Home</a></li>
                            <li id='service-nav' class="nav-item ntab ps-2 pe-2"><a id='servicesNav' class="nav-link navlink white" href="index?part=service">Service</a></li>
                            <li id='aboutus-nav' class="nav-item ntab ps-2 pe-2"><a id='aboutNav' class="nav-link navlink white" href="index?part=aboutus">About us</a></li>
                            <li id='contacts-nav' class="nav-item ntab ps-2 pe-2"><a id='contactsNav' class="nav-link navlink white" href="index?part=application">Contacts</a></li>
                            <li class="nav-item langtab"><a id='lang' class="nav-link langlink white" href="#"><img class='langico' src='Images/lang.svg' alt='lang'/>Ar</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
